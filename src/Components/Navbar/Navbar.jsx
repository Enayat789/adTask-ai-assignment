...
const Navbar = () => {
  ...
  return (
    <div className="w-full relative flex flex-col items-center justify-center sm:my-4">
      <div className="bg-gradient-to-r from-gray-900 to-gray-950 relative w-full sm:w-[98%] h-auto px-6 p-5 md:p-2 max-w-6xl flex justify-between items-center text-white sm:rounded-2xl sm:border border-gray-600">
        {/* Grid Lines */}
        ...
        <h1 className="font-extrabold relative cursor-pointer text-xl md:text-lg sm:px-4">
          adTask.ai
        </h1>

        {/* Desktop Menu */}
        <div className="md:flex md:w-[66%] lg:w-[64%] relative hidden  justify-between items-center font-extralight">
          ...
          <div className="flex gap-4 pr-2">
            ...
            <button className="border hidden lg:block border-gray-400 cursor-pointer bg-gray-900 py-2 px-6 rounded-full">
              Schedule a Call
            </button>
            <button className="border block lg:hidden border-gray-400 cursor-pointer p-3 rounded-full">
              <img src="Vector (14).png" alt="" className="w-full h-full" />
            </button>
          </div>
        </div>
