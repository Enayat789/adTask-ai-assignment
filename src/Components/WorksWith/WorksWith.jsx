...
const WorksWith = () => {
  return (
    <div className="w-full h-auto md:h-[50vh] flex flex-col items-center justify-center p-4 gap-4">
      <div className="">
        <p>Adtask AI works with :</p>
      </div>
      <div className="flex flex-wrap w-full h-auto md:h-[19vh] max-w-5xl items-center justify-between gap-4">
